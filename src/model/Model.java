...
public class Model {
    ...
    public Model() {
        URL url = Objects.requireNonNull(
                Model.class.getResource("/res/levels"), // or "/res/level.txt" if the file has the extension.
                "Resource /res/level not found in classpath"
        );
        try {
            levelLoader = new LevelLoader(Paths.get(url.toURI()));
        } catch (URISyntaxException e) {
            throw new RuntimeException("Invalid resource URI /res/level", e);
        }
    }
